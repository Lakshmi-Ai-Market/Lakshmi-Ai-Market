...
def analyze_all_strategies(user_input):
    ...
    strategies = [
        ...
        supertrend(candles),
        bollinger_band_squeeze(candles),
        marubozu_bullish(candles),
        marubozu_bearish(candles),
        bullish_engulfing(candles),
        bearish_engulfing(candles),
        morning_star(candles),
        evening_star(candles),
        hammer_candle(candles),
        inverted_hammer(candles),
        spinning_top(candles),
        harami_bullish(candles),
        harami_bearish(candles),
        three_white_soldiers(candles),
        three_black_crows(candles),
        piercing_pattern(candles),
        dark_cloud_cover(candles),
        doji_star_bullish(candles),
        doji_star_bearish(candles),
        tweezers_bottom(candles),
        tweezers_top(candles)
    ]
